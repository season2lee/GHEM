...
@EnableJpaRepositories(
        basePackages = "com.ssafy.ghem.convenience.model.respository.individual", // Second Repository 경로
...
public class IndividualConfig {
    ...
    public LocalContainerEntityManagerFactoryBean individualManager() {
        ...
        em.setPackagesToScan(new String[] { "com.ssafy.ghem.convenience.model.entity" });
